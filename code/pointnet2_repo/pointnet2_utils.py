...
import pointnet2_repo.pytorch_utils as pt_utils
import sys, os
...
from ops_utils import ball_query as bq


class QueryAndGroupPNOld(nn.Module):
    """
    NOTICE: this class is only used for aggregation (proposal) PointNet after voting.
    """
    def __init__(self, radius, nsample, use_xyz=True):
        super(QueryAndGroupPNOld, self).__init__()
...
class QueryAndGroupKPOld(nn.Module):
    r"""
