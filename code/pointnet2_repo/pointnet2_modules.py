...
class EquivPointnetSAModuleVotes(nn.Module):
    ...
    def forward(self, xyz: torch.Tensor,
        ...
        # First 3 coordinates are xyz
        gxyz = grouped_features[:,:3]
...
class PointnetSAModuleVotes(nn.Module):
    ...
    def __init__(
        ...
        self.grouper = pointnet2_utils.QueryAndGroupPNOld(radius, nsample, use_xyz=use_xyz)
